...
const Options: React.FC<ModalProps> = ({
  show,
  onClose,
  children,
  handleModalData,
        ...
        <StyledModalBody>
          ...
          >
            <button
              ...
              data-tooltip={
                children
                  ? "Uses Preset Global Ownerhash"
                  : "No Global Ownerhash Found"
              }
              disabled={!children}
            >
          ...
          >
            ...
            <button
              ...
              onClick={() => {
                setHelpModal(true);
                setHelp(
                  '<span><span style="color: cyan">Recordhash</span> is specific to each name and it is a faster but expensive option</span>'
                );
              }}
          ...
          >
            ...
            <button
              ...
              onClick={() => {
                setHelpModal(true);
                setHelp(
                  '<span><span style="color: cyan">HTTP Gateway</span> can point to a <span style="color: cyan">web<span style="font-family: \'SF Mono\'; font-size: 15px">2</span></span> gateway or <span style="color: cyan">L<span style="font-family: \'SF Mono\'; font-size: 15px">2</span></span> proxy</span>'
                );
              }}
