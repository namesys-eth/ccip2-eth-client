...
const Gateway: React.FC<ModalProps> = ({
  show,
  onClose,
  children,
  handleModalData,
            ...
            >
              ...
              <button
                ...
                onClick={() => {
                  setHelpModal(true),
                    setHelp(
                      '<span><span style="color: cyan">HTTP Gateway</span> should be a <span style="color: orange">HTTPS<span style="font-family: \'SF Mono\'">:</span>//</span> URL</span>'
                    );
                }}
