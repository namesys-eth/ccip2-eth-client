          ...
          >
                ...
                {item.migrated === "1" && (
                  <button
                    ...
                    onClick={() => {
                      ...
                      setColor("lime");
                      setHelp(
                        '<span><span style="color: lime">Ready</span> For Off-chain Use. Domain-specific <span style="color: cyan">Recordhash</span> is Set</span>'
                      );
                    }}
                ...
                {item.migrated === "3/4" && (
                  <button
                    ...
                    onClick={() => {
                      ...
                      setColor("cyan");
                      setHelp(
                        '<span><span style="color: lime">Ready</span> For Off-chain Use. Global <span style="color: cyan">Ownerhash</span> is Set</span>'
                      );
                    }}
                ...
                {item.migrated === "4/5" && (
                  <button
                    ...
                    onClick={() => {
                      ...
                      setColor("yellow");
                      setHelp(
                        '<span><span style="color: lime">Ready</span> For Off-chain Use. <span style="color: cyan">HTTP Gateway</span> is Set</span>'
                      );
                    }}
                ...
                {item.migrated === "1/2" && (
                  <button
                    ...
                    onClick={() => {
                      ...
                      setColor("orange");
                      setHelp(
                        '<span>Resolver is <span style="color: lime">migrated</span> but <span style="color: cyan">Storage</span> is <span style="color: orange">not Set</span></span>'
                      );
                    }}
                ...
                {item.migrated === "0" && (
                  <button
                    ...
                    onClick={() => {
                      ...
                      setColor("orangered");
                      setHelp(
                        '<span>Resolver is <span style="color: orange">not migrated</span>. Please <span style="color: cyan">MIGRATE</span> to enable off-chain Records</span>'
                      );
                    }}
            ...
            <div>
              <a
                ...
                rel="noreferrer"
              >
                <img className="icon-ens-small" alt="ens-icon" src="ens.png" />
              </a>
              <a
