...
export async function KEYGEN(
  ...
  let ed25519priv = ed25519legacy.utils
    .hashToPrivateScalar(hashKey)
    .toString(16)
    .padStart(64, "0"); // ed25519 (IPNS) Private Key
  let ed25519pub = ed25519latest.etc.bytesToHex(
    await ed25519legacy.getPublicKey(ed25519priv)
  ); // ed25519 (IPNS) Public Key
