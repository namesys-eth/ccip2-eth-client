...
const Account: NextPage = () => {
  ...
  } = useAccount(); // Wagmi connector hook
  ...
  const [inProcess, setInProcess] = React.useState(
    ethers.utils.namehash("0.eth")
  ); // Stores name under process
  ...
  const _Chain_ =
    activeChain &&
    (activeChain.name.toLowerCase() === "mainnet" ||
  ...
  React.useEffect(() => {
    if (
      ...
      !keypairIPNS[0] &&
      !keypairIPNS[1] &&
      !choice.endsWith("_IPNS") &&
      exportModalState.modalData !== "2"
    ) {
      if (choice === "export") {
  ...
  React.useEffect(() => {
    if (
      ...
      keypairIPNS[0] &&
      keypairIPNS[1] &&
      !choice.endsWith("_Signer")
    ) {
      if (
        ["export_IPNS", "export_HTTP"].includes(choice) &&
        exportModalState.modalData
      ) {
        ...
        signMessage({
          message: statementSignerKey(
            ["1", "2"].includes(exportModalState.modalData)
  ...
  React.useEffect(() => {
    if (!finish && !success && inProcess && activeTab === "OWNER") {
      // Prohibit wallet change when names are loading
      setMessage("Loading Names");
    } else if (!finish && !success && !inProcess) {
          ...
          for (var i = 0; i < allTokens.length; i++) {
            if (
              ...
              const _ManagerLegacy = await contractLegacy.owner(
                ethers.utils.namehash(allTokens[i].title)
              );
              if (_ManagerLegacy === _Wallet_) {
                ...
                _Recordhash_ = await contract.getRecordhash(
                  ethers.utils.namehash(allTokens[i].title)
                );
                if (
                  _Recordhash_ &&
      ...
      const setMetadata = async () => {
        constants.provider.getResolver(query).then((_RESPONSE) => {
          ...
          if (items.length > 0) {
            if (
              recordhash &&
              String(recordhash) !== "0x" &&
              String(recordhash) !== String(ownerhash) &&
  ...
  const {
    isSuccess: txSuccess1of2,
    isError: txError1of2,
    isLoading: txLoading1of2,
  } = useWaitForTransaction({
    hash: response1of2?.hash,
  });
  const {
    isSuccess: txSuccess2of2,
    isError: txError2of2,
    isLoading: txLoading2of2,
  } = useWaitForTransaction({
  ...
  return (
    ...
    >
      ...
      {!isMobile && (
        ...
        >
          <img className="avatar" alt="corner-account" src="logo.png" />
        </div>
      )}
      <Head>
      ...
      >
        {/* Content */}
        <div
          className={!isMobile && !isSearch ? "heading-alt" : "none"}
          style={{
            flex: "1 1 auto",
        ...
        >
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      setColor("cyan");
                      setHelp(
                        '<span>This list <span style="color: orangered">does not</span> contain <span style="color: orange">Wrapped Names</span> or <span style="color: orange">Freshly Registered Names</span> or <span style="color: orange">Subdomains</span> or <span style="color: orange">Legacy Names that you Manage but do not Own</span>. Please use the <span style="color: cyan">Search</span> tab to find missing names.</span>'
                      );
                    }}
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      setColor("cyan");
                      setHelp(
                        '<span>NameSys Utility Functions to set <span style="color: cyan">Ownerhash</span> and <span style="color: cyan">Export Keys</span></span>'
                      );
                    }}
                    data-tooltip="Enlighten me"
                  >
                  ...
                  >
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        setColor("cyan");
                        setHelp(
                          '<span>Sets <span style="color: cyan">Ownerhash</span> For All Names in a Wallet</span>'
                        );
                      }}
                ...
                >
                  ...
                  >
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        setColor("cyan");
                        setHelp(
                          '<span>Export your <span style="color: cyan">IPNS</span> and/or Records <span style="color: cyan">Signer</span> Keys</span>'
                        );
                      }}
                    ...
                    >
                      <input
                        style={{
                          ...
                          textAlign: "left",
                          color:
                            keypairIPNS[0] === "IPNS PRIVATE KEY COPIED!"
                              ? "lime"
                              : "rgb(255, 255, 150, 0.75)",
                        }}
                        type="text"
                      ...
                      <button
                        ...
                        style={{
                          marginLeft: "-25px",
                          color:
                            color && !keypairIPNS[0] && !keypairIPNS[1]
                              ? color
                              : "cyan",
                        }}
                    ...
                    >
                      <input
                        style={{
                          ...
                          textAlign: "left",
                          color:
                            keypairSigner[0] === "RECORDS SIGNER KEY COPIED!"
                              ? "lime"
                              : "rgb(255, 255, 150, 0.75)",
                        }}
                        type="text"
                        ...
                        value={
                          !choice.startsWith("export") ? "" : keypairSigner[0]
                        }
                        id="export-ccip"
                        disabled
                      />
                      <button
                        ...
                        style={{
                          marginLeft: "-25px",
                          color:
                            color && !keypairSigner[0] && !keypairSigner[1]
                              ? color
                              : "cyan",
                        }}
                    ...
                    >
                      <input
                        style={{
                          ...
                          textAlign: "left",
                          color:
                            keyIPNS === "IPNS ENCODED KEY COPIED!"
                              ? "lime"
                              : "rgb(255, 255, 150, 0.75)",
                        }}
                        type="text"
                  ...
                  <div className="flex-row">
                    ...
                    <div
                      ...
                      style={{
                        color:
                          keyIPNS || keypairIPNS[0] || keypairSigner[0]
                            ? "lime"
                            : signError
                            ? "orangered"
                            : "",
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      setColor("cyan");
                      setHelp(
                        '<span>Search for a <span style="color: cyan">Subdomain</span> or a <span style="color: cyan">Wrapped Domain</span> or a <span style="color: cyan">Legacy name that you Manage but do not Own</span></span>'
                      );
                    }}
                    data-tooltip="Enlighten me"
                  >
          ...
          {!loading && empty && activeTab === "OWNER" && !errorModal && (
            <div>
              ...
              >
                <span className="material-icons-round miui-smaller">
                  warning
                </span>
                <br></br>
                No Names Found
