...
const customTheme: Theme = {
  ...
  colors: {
    ...
    closeButtonBackground:
      "linear-gradient(112deg, rgba(198,127,105,1) 0%, rgba(218,85,81,1) 48%, rgba(212,160,99,1) 100%)",
    connectButtonBackground:
      "linear-gradient(112deg, rgba(190,95,65,1) 0%, rgba(191,41,36,1) 48%, rgba(203,111,0,1) 100%)",
    connectButtonBackgroundError: "red",
    connectButtonInnerBackground:
      "linear-gradient(153deg, rgba(190,95,65,1) 0%, rgba(152,33,30,1) 48%, rgba(203,111,0,1) 100%)",
    ...
    modalBackdrop: "none",
    modalBackground:
      "linear-gradient(42deg, rgba(125,90,78,1) 0%, rgba(97,53,38,1) 100%)",
    modalBorder: "white",
    modalText: "white",
    modalTextDim: "white",
